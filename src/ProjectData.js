...
const ProjectData = [
...

    {
        ...
        projectText: "It is a clone website of the popular GIF distributing service Giphy using the Giphy API endpoints. A total of two Giphy API endpoints are being used in this project (trending and searching) https://api.giphy.com/v1/gifs/trending https://api.giphy.com/v1/gifs/search. Users can Browse and look through the trending GIFs on the Giphy platform. The users can also search for a term that they want the GIFs search results for. The user login button takes the user to the actual Giphy Login portal. The GIFs are being displayed in a beautiful masonry layout for a space efficient design like the actual website. ",
